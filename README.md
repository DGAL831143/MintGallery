...
MintGallery 是一个本地优先的私密家庭相册。当前版本支持管理员初始化、家庭成员账号、普通照片与视频上传、手动配对 Live Photo、外部文件夹扫描导入、重复项确认、按拍摄时间浏览、搜索、照片信息面板、防窥隐私照片、共享/私密图片墙、个人文件夹、受保护的媒体访问，以及 Tailscale 私有访问的自动启动与健康检查。
...
相册顶部提供搜索入口，可在当前“家庭共享/仅自己可见”、文件夹和月份筛选范围内搜索文件名、上传者和媒体类型（照片、视频、实况）。

打开照片查看器后，可通过信息入口查看文件名、类型、大小、拍摄时间、上传时间、上传者、可见范围和防窥状态。上传者或管理员可以在信息面板中修改“家庭共享/仅自己可见”和“设为防窥/取消防窥”；选择模式下也支持批量修改。
...
- 已支持当前范围内搜索、照片信息面板、防窥遮挡，以及单张/批量修改防窥状态和可见范围。
